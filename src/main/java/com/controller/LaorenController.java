    ...
    */
    ...
    public R save(@RequestBody LaorenEntity laoren, HttpServletRequest request){
        ...
        Wrapper<LaorenEntity> queryWrapper = new EntityWrapper<LaorenEntity>()
            ...
            .eq("laoren_types", laoren.getLaorenTypes())
            .eq("jibing_types", laoren.getJibingTypes())
            ;
...
//                            laorenEntity.setLaorenAge(Integer.valueOf(data.get(0)));   //老人年纪 要改的
//                            laorenEntity.setLaorenTypes(Integer.valueOf(data.get(0)));   //老人身体状态 要改的
//                            laorenEntity.setJibingTypes(Integer.valueOf(data.get(0)));   //是否有疾病 要改的
//                            laorenEntity.setLaorenContent("");//照片
